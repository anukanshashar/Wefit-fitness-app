...
public class Utkatasana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.utkatasana);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        TextView instruction =  (TextView) findViewById(R.id.instructions);
        instruction.setText("This pose is basically a squat, keeping balance, deep breathing and holding. Hold for 30 seconds to a minute.");
        runTimer();
    }

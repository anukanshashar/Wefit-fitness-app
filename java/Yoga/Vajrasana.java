...
public class Vajrasana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.vajrasana);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        TextView instruction =  (TextView) findViewById(R.id.instructions);
        instruction.setText("The position is basically sitting down on your legs with your heels touching your bottom. Pretty simple right? You should hold this pose for two minutes if you’re just starting out.");
        runTimer();
    }

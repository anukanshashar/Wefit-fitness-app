...
public class Bhadrasana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.bhardrasans);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        TextView instruction =  (TextView) findViewById(R.id.instructions);
        instruction.setText("This pose has you sitting down with your legs apart and feet touching each other. Relax your head, neck and spine. Hold for as long as your comfortable.");
        runTimer();
    }

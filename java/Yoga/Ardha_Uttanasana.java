...
public class Ardha_Uttanasana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.ardha_uttanasana);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        TextView instruction =  (TextView) findViewById(R.id.instructions);
        instruction.setText("For this pose you stand straight up and fold forward, while keeping your spine extended. Go at this one slowly especially if your back isn’t used to bending. Hold for 30 seconds to a minute.");
        runTimer();
    }

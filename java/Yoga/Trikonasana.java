...
public class Trikonasana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.trikonasana);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        TextView instruction =  (TextView) findViewById(R.id.instructions);
        instruction.setText("Stand with legs apart and extend your arms. When you have your arm extended to the right, drop your right arm so your right hand reaches the front of your right foot. Breath and hold for 5 to 6 breaths.");
        runTimer();
    }

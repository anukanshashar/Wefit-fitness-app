...
public class Shavasana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.shavanas);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        TextView instruction =  (TextView) findViewById(R.id.instructions);
        instruction.setText("For this pose you will lie down letting your muscles deeply relax and keep breathing into your abdomen. Try to ignore distractions and clear your mind by focusing on your breathing. Hold this pose as long as you are comfortable.  When you’re finished with the exercise get up very slowly.");
        runTimer();
    }

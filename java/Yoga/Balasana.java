...
public class Balasana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.balsaans);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        TextView instruction =  (TextView) findViewById(R.id.instructions);
        instruction.setText("For the position you get onto your hands and knees and then relax your arms and let your forehead rest on the floor.");
        runTimer();
    }

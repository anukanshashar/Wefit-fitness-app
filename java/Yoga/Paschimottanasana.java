...
public class Paschimottanasana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.paschimottanasana);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        TextView instruction =  (TextView) findViewById(R.id.instructions);
        instruction.setText("For this pose you’ll be sitting on the floor with legs extended out. Focus on leaning  towards your toes instead of towards your knees.");
        runTimer();
    }

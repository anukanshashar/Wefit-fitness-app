...
public class Pawanmuktasana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.pawanmuktasana);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        TextView instruction =  (TextView) findViewById(R.id.instructions);
        instruction.setText("For this pose you get into a fetal position on your back with your knees drawn up towards your chest. You will hold your knees and then lower your right leg and straighten it while still holding on to your left leg. Hold pose for up to a minute.");
        runTimer();
    }

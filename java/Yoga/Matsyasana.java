...
public class Matsyasana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.matsyaans);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        TextView instruction =  (TextView) findViewById(R.id.instructions);
        instruction.setText("Lie on your back and bend your knees while resting your feet on the floor. Inhale while lifting your pelvis slightly off the floor and slide your hands, palms down, below your bottom. Hold for 15 to 30 seconds.");
        runTimer();
    }

...
import com.example.fitnessapp.indiviual_exc.Chin_ups;
import com.example.fitnessapp.indiviual_exc.Inclined_Chin_Ups;
import com.example.fitnessapp.indiviual_exc.Shoulder_Blades_Crusher;
import com.example.fitnessapp.indiviual_exc.Shoulder_Press;
import com.example.fitnessapp.indiviual_exc.Shoulder_Press_first_shoulder;
import com.example.fitnessapp.indiviual_exc.Straight_Cable_Curls;
import com.example.fitnessapp.rest_exc.R_N_chin_ups;
import com.example.fitnessapp.rest_exc.R_N_inclined_chin_ups;
import com.example.fitnessapp.rest_exc.R_N_shoulder_press;
import com.example.fitnessapp.rest_exc.R_N_shoulder_press_first_shoulder;
import com.example.fitnessapp.rest_exc.R_N_straight_cable_curls;
import com.example.fitnessapp.start.Start_Shoulders_Shoulder_Blades_Crusher;
...
public class Shoulder extends AppCompatActivity {
    ...
    private void start() {
        Intent intent = new Intent(this, Start_Shoulders_Shoulder_Blades_Crusher.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==2 && i<temp){
            Intent intent = new Intent(this, Shoulder_Blades_Crusher.class);
            startActivityForResult(intent,3);
        }

        else if(requestCode == 3 ){
            Intent intent = new Intent(this, R_N_shoulder_press_first_shoulder.class);
            startActivityForResult(intent,4);

        }
        else if(requestCode == 4){
            Intent intent = new Intent(this, Shoulder_Press_first_shoulder.class);
            ...
            Intent intent = new Intent(this, R_N_chin_ups.class);
            startActivityForResult(intent,10);
        }
        else if(requestCode == 10){
            Intent intent = new Intent(this, Chin_ups.class);

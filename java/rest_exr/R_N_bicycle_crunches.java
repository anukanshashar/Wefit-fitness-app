...
public class R_N_bicycle_crunches extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instruction.setText("1. Lie on your back, lift your shoulders off the mat and raise both legs.\n" +
                ...
                "When doing bicycle crunches, engage your core muscles,open the elbows and keep yourneck relaxed.Breathe outas you crunch,keep your shoulderlades off and maintain asteady rhythm throughout theentire exercise.");
        runTimer();
    }

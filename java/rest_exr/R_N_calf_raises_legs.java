...
public class R_N_calf_raises_legs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.legs_exersices_calf_raises);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        name.setText("Calf Raises");
        TextView instruction =  (TextView) findViewById(R.id.instructions);
        instruction.setText("1. Stand with your torso upright, your feet hip-width apart, and your toes pointing forward.\n" +

...
public class R_N_side_cable_curls extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.exersice_35_bicep_cable_curl);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        name.setText("Side Cable Curls");
        TextView instruction =  (TextView) findViewById(R.id.instructions);
        instruction.setText("1. Curl the cable weight upward, toward the chest, while breathing out. Only the forearms move, rising up from the elbow.\n" +

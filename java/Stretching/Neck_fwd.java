...
public class Neck_fwd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.neck_fwd_bend);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        name.setText("Neck Forward Push");
        ...
        instruction.setText("1. Stand erect aligning your body in a straight line.\n" +
                "2. Extend your hands in front and make an interlocking between you fingers, gently put it on your forehead.\n" +
                "3. Gently push your head at front until you feel a comfortable stretch in the opposite side.\n" +

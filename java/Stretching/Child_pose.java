...
public class CHild_Pose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.child_pose);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        name.setText("Child Pose");
        ...
        instruction.setText("1. Get down on your hands and knees.\n" +
                ...
                "3. Rest your forehead on the mat and relax"+

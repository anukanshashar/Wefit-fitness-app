...
public class Neck_Side extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.neck_side_bend);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        name.setText("Neck Side-to-Side");
        ...
        instruction.setText("1. Stand erect aligning your body in a straight line.\n" +
                "2. Extend your left hand and rest the palms on the right ear gently.\n" +
                "3. Gently pull your head to left side until you feel a comfortable stretch in the opposite side of bending.\n" +
                "4. Hold for 15 seconds and switch.\n\n" +
                "Breath gently when tilting to one side and breath out coming back to normal position. Do not force yourself to do more.");
        runTimer();
    }

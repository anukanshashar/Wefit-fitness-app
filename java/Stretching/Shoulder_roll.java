...
public class Shoulder_Roll extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.shoulder_roll);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        name.setText("Shoulder Roll");
        ...
        instruction.setText("1. Stand erect aligning your body in a straight line.\n" +
                "2. Gently roll your shoulders clockwise for 15 seconds"+
                "4. Switch to anticlockwise for the net 15 seconds.\n\n" +
                "Breath gently and do not force yourself to do more.");
        runTimer();
    }

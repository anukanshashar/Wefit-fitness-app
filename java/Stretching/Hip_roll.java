...
public class Hip_Roll extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.hip_roll);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        name.setText("Hip Rotation");
        TextView instruction =  (TextView) findViewById(R.id.instructions);
        instruction.setText("1. Stand straight with your feet a little wider than shoulder-width apart. Bend the knees slightly and place your hands on the hips.\n"+

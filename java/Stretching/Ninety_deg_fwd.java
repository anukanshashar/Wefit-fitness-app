...
public class Ninety_deg_fwd_bend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.ninety__deg_fwd_bend);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        name.setText("90 degree Forward Bend");
        TextView instruction =  (TextView) findViewById(R.id.instructions);
        instruction.setText("11. Sit down with your legs spread in front parallel to each other\n"+
                "2. Bend your left leg and keep above your right thigh\n"+
                "3. Bend your back as much as comfortable in front adn hold\n"+

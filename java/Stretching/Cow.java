...
public class Cow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.cow);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        name.setText("Cow Stretch");
        ...
        instruction.setText("1. Start on your hands and knees with your wrists directly under your shoulders, and your knees directly under your hips.\n" +
                ...
                "5. Inhale as you drop your belly towards the mat. Lift your chin and chest, and gaze up toward the ceiling.\n"+

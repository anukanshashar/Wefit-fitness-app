...
public class Knee_to_CHest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.knee_to_chest);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        name.setText("Knee to Chest");
        TextView instruction =  (TextView) findViewById(R.id.instructions);
        instruction.setText("1. Lie on your back with your legs extended and back straight.\n" +
                "2. Keep you hips level and your lower back down on the floor.\n"+
                "3. Bend your right knee and hug your knee towards your chest, placing hands on your right leg.\n"+

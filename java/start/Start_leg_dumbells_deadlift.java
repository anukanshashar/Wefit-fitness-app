...
public class Start_Legs_Dumbell_DeadLift extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instruction.setText("1. Pick up a pair of dumbbells with an overhand grip and hold them in front of your sides. Stand with your knees slightly bent, and your feet placed shoulder-width apart. \n" +
                ...
                "4. From this position, stand up straight without changing the shape of your back. Famatumi recommends squeezing your glutes as you straight, pushing through the ball and heel of your foot. That’s one rep.  ");
        runTimer();
    }

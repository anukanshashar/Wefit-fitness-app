...
public class Start_Back_Leg_Lifts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.exersice_5);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        name.setText("Leg Raise");
        TextView instruction =  (TextView) findViewById(R.id.instructions);
        instruction.setText("1. Lie on your back with your hands by your sides or underneath your glutes. Keep your legs straight or just slightly bent.\n" +

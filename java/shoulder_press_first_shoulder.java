...
public class R_N_shoulder_press_first_shoulder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif.setBackgroundResource(R.drawable.exersice_32);
        TextView name =  (TextView) findViewById(R.id.exc_name);
        name.setText("Shoulder Press Modified");
        TextView instruction =  (TextView) findViewById(R.id.instructions);
        instruction.setText("1. Lie down on a flat bench and hold a dumbbell in each hand.\n" +
                "2. Align your elbows in a straight line with shoulders and your elbows under your wrists.\n" +
                "3. Push the dumbbells up and fully extend your arms.\n" +
                "4. Lower the dumbbells back down and repeat the movement until the set is complete.\n\n"+
